...
When you spot an issue, [create an issue](https://github.com/robertdebock/ansible-role-bareos_console/issues).

Making the issue help me and others to find similar problems in the future.

### [2. Fork the project.](#2-fork-the-project)

On the top right side of [the repository on GitHub](https://github.com/robertdebock/ansible-role-bareos_console), click `fork`. This copies everything to your GitHub namespace.
...
```shell
git clone git@github.com:YOURNAMESPACE/ansible-role-bareos_console.git
```
